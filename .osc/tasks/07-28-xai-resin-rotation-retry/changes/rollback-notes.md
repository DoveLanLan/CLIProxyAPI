...
The existing CPA rollback point is
`/opt/cliproxyapi/backups/xai-resin-retry-20260728T121546Z`. Keep it until the
ordered Resin and CPA workflow deployments and post-deploy stability checks
have passed.
